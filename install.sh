#!/usr/bin/env sh
# Universal installer for windows-toolkit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/windows-toolkit.git"
echo "Installing windows-toolkit ..."
...
echo "Done. Run: windows-toolkit --help"
